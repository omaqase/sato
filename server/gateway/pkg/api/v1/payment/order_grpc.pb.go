...
const (
	OrderService_CreateOrder_FullMethodName       = "/api.v1.order.OrderService/CreateOrder"
	OrderService_GetOrder_FullMethodName          = "/api.v1.order.OrderService/GetOrder"
	OrderService_ListOrders_FullMethodName        = "/api.v1.order.OrderService/ListOrders"
	OrderService_UpdateOrderStatus_FullMethodName = "/api.v1.order.OrderService/UpdateOrderStatus"
	OrderService_CancelOrder_FullMethodName       = "/api.v1.order.OrderService/CancelOrder"
)
...
var OrderService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.v1.order.OrderService",
