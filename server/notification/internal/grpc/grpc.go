...
func NewGRPCServer(lc fx.Lifecycle, service protobuf.NotificationServiceServer, config config.Config) (*Server, error) {
	...
	protobuf.RegisterNotificationServiceServer(server, service)
