    ...
    <div class="space-y-8">
        ...
        <div class="flex items-start gap-6">
          ...
          <div class="flex-1">
            <div class="flex items-center justify-between mb-4">
              <div>
                <h2 class="text-xl font-semibold text-gray-900">{{ method.title }}</h2>
                <p class="text-gray-600">{{ method.description }}</p>
              </div>
              <div class="text-right">
                <div class="text-2xl font-bold text-gray-900">{{ method.price }}</div>
                <div class="text-sm text-gray-500">{{ method.time }}</div>
              </div>
            </div>
            ...
            <div class="bg-gray-50 rounded-xl p-4">
              <ul class="space-y-3">
                ...
                >
                  <svg class="w-5 h-5 text-green-500 flex-shrink-0" viewBox="0 0 24 24" fill="none">
                    <path
                      d="M20 6L9 17l-5-5"
                      stroke="currentColor"
                      stroke-width="2"
      ...
      <div class="bg-blue-50 rounded-2xl p-6">
        <div class="flex items-start gap-4">
          ...
          <div>
            <h3 class="text-lg font-medium text-gray-900 mb-2">Отслеживание заказа</h3>
...
const deliveryMethods = [
  ...
  },
  {
    ...
    time: '1-3 дня',
    icon: TruckIcon,
    features: ['Более 100 пунктов выдачи', 'Примерка перед покупкой', 'Хранение заказа 7 дней'],
  },
  {
    id: 3,
    title: 'Казпочта',
    description: 'Доставка в любую точку Казахстана',
    price: 'от 1490 ₸',
    time: '3-10 дней',
    icon: TruckIcon,
    features: ['Доставка по всему Казахстану', 'Наложенный платеж', 'Трекинг отправления'],
  },
]
</script>
